...
export class RedisCacheAPIWrapper<TEntity extends { [k: string]: number | string | null }, TUniqueKey extends keyof TEntity = 'id'>
  implements CacheAPIWrapper<TEntity, TUniqueKey>
{
  constructor(private readonly redisClient: RedisClient, private keyPrefix: string, private readonly cacheTtlSeconds: number = 360) {}
